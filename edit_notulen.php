    ...
    if(empty($_SESSION['admin'])){
        ...
        die();
            ...
            <?php
                ...
                $mulai = date("H:i", strtotime($mulai));
                $selesai = date("H:i", strtotime($selesai));
                ...
                <form id="main-form" class="col s12" method="POST" action="edit_notulen_database.php" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="input-field col s12 m6">
                            ...
                            <input id="tema" type="text" class="validate" name="tema" value="<?php echo $tema; ?>" required>
                                <?php
                        ...
                        <div class="input-field col s12 m12">
                            ...
                            <textarea id="sia" class="materialize-textarea validate" name="sia"><?php echo $sia; ?></textarea>
                                <?php
                        ...
                        <div class="input-field col s12 m12">
                            <i class="material-icons prefix md-prefix">info_outline</i>
                            <textarea id="ssa" class="materialize-textarea validate" name="ssa"><?php echo $ssa; ?></textarea>
                                <?php
                        ...
                        <div class="input-field col s12 m12">
                            <i class="material-icons prefix md-prefix">info_outline</i>
                            <textarea id="liw1" class="materialize-textarea validate" name="liw1"><?php echo $liw1; ?></textarea>
                                <?php
                        ...
                        <div class="input-field col s12 m12">
                            <i class="material-icons prefix md-prefix">info_outline</i>
                            <textarea id="liw2" class="materialize-textarea validate" name="liw2"><?php echo $liw2; ?></textarea>
                                <?php
                        ...
                        <div class="input-field col s12 m12">
                            <i class="material-icons prefix md-prefix">info_outline</i>
                            <textarea id="liw3" class="materialize-textarea validate" name="liw3"><?php echo $liw3; ?></textarea>
                                <?php
                        ...
                        <div class="input-field col s12 m12">
                            <i class="material-icons prefix md-prefix">info_outline</i>
                            <textarea id="liw4" class="materialize-textarea validate" name="liw4"><?php echo $liw4; ?></textarea>
                                <?php
                        ...
                        <div class="input-field col s12 m12">
                            <i class="material-icons prefix md-prefix">info_outline</i>
                            <textarea id="kpk" class="materialize-textarea validate" name="kpk"><?php echo $kpk; ?></textarea>
                                <?php
                        ...
                        <div class="input-field col s12 m12">
                            <i class="material-icons prefix md-prefix">info_outline</i>
                            <textarea id="kep" class="materialize-textarea validate" name="kep"><?php echo $kep; ?></textarea>
                                <?php
                        ...
                        <div class="input-field col s12 m12">
                            <i class="material-icons prefix md-prefix">info_outline</i>
                            <textarea id="kup" class="materialize-textarea validate" name="kup"><?php echo $kup; ?></textarea>
                                <?php
                        ...
                        <div class="input-field col s12 m12">
                            <i class="material-icons prefix md-prefix">info_outline</i>
                            <textarea id="tl" class="materialize-textarea validate" name="tl"><?php echo $tl; ?></textarea>
                                <?php
                        ...
                        <div class="input-field col s12 m12">
                            <i class="material-icons prefix md-prefix">info_outline</i>
                            <textarea id="penutup" class="materialize-textarea validate" name="penutup"><?php echo $penutup; ?></textarea>
                                <?php
                        ...
                        <div class="input-field col s12 m6">
                            ...
                            <input id="mulai" type="time" name="mulai" class="timepicker" value="<?php echo $mulai; ?>" required>
                                <?php
                        ...
                        <div class="input-field col s12 m6">
                            <i class="material-icons prefix md-prefix">alarm</i>
                            <input id="selesai" type="time" name="selesai" class="timepicker" value="<?php echo $selesai; ?>" required>
                                <?php
