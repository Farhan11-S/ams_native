...
<div class="container">
    ...
    <div class="row card-detail">
        <div class="card" style="padding: 5px;">
            <div class="delete-title red-text"><i class="material-icons md-36">error_outline</i>Apakah Anda yakin akan menghapus data ini?</div>
    <?php 
        ...
        ?>
            ...
            <div class="card-action row">
                ...
                <a href="?page=tsm&submit=1&act=del&id=<?php echo $id; ?>" class="col m2 s5 btn-large deep-orange waves-effect waves-light white-text"><i class="material-icons">delete</i> HAPUS</a>
            </div>
    <?php
        } else {
    ?>
